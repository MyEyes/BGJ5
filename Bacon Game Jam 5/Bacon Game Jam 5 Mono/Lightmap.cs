...
namespace Bacon_Game_Jam_5
{
    ...
    public class Lightmap
    {
        ...
        public Lightmap(GraphicsDevice device, ContentManager Content)
        {
            ...
            _device = device;
            LightEffect = Content.Load<Effect>("LightEffect.mgfx");
            ...
            _noDraw.ColorDestinationBlend = Blend.One;
            _noDraw.ColorSourceBlend = Blend.Zero;
            _noDraw.ColorWriteChannels = ColorWriteChannels.None;
            _noDraw.ColorWriteChannels1 = ColorWriteChannels.None;
            _noDraw.AlphaSourceBlend = Blend.Zero;
            _noDraw.AlphaDestinationBlend = Blend.One;
        }
